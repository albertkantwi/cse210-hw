...
class Program
{
    static void Main(string[] args)
    {
        ...
        Address jaddress = new Address("1167 Apple Street", "Accra City", "GH", "Ghana");
        Address paddress = new Address("14925 Nkrumah Circle", "Madina", "Ga West", "Ghana");
        Customer customer1 = new Customer("Albert Antwi", jaddress);
        Customer customer2 = new Customer("Zegeh Noah", paddress);
